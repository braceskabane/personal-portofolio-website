    ...
    <>
      <section id="projects" ref={ref} className="py-20 relative">
        <div className="container mx-auto px-6">
          ...
          <div
            className={`flex flex-col sm:flex-row justify-between items-center mb-12 gap-4 transition-all duration-1000 delay-200 ${
              isIntersecting
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
          ...
          {/* View More Projects */}
          <div
            className={`text-center mt-10 md:mt-16 transition-all duration-500 md:duration-1000 ${
              isIntersecting
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
          ...
          >
            <Card variant="glass" padding="large" className="inline-block">
              ...
              <Button
                ...
                icon={<Github size={20} />}
                onClick={() =>
                  window.open("https://github.com/braceskabane", "_blank")
                }
              >
                View All Projects
              </Button>
